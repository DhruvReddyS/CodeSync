...
exports.scrapeAtcoder = scrapeAtcoder;
const axios_1 = __importDefault(require("axios"));
function emptyStats(username) {
    return {
        username,
        rating: null,
        highestRating: null,
...
async function scrapeAtcoder(username) {
    ...
    try {
        ...
        const titleMatch = html.match(/user-(?:[^"]+)">([\w\s]+?master)<\/span>/i) || // GM, LGM, Master
        ...
        const historyRes = await axios_1.default.get(csvUrl, { responseType: "text" });
